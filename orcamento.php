        ...
        <main>
            ...
            <div>
                <form class="input-group" method="POST">
                    <input type="text" class="form-control mt-3" placeholder="Pesquisar em orçamentos pendentes" name="search">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="formatbtn ">
                                            <div class="text-right">
                                                ...
                                                <a type="button" href="editorcamento.php?id=<?php echo $id_orcamento ?>" class="btn btn-primary">Interagir</a>
                                            </div>
                                        </div>
                                    </div>
