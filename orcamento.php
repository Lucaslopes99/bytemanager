                                ...
                                <div class="row ">
                                    ...
                                    <div class="formatbtn ">
                                        <div class="text-right">
                                            <a type="button" href="edit.php?id=<?php echo $id_orcamento ?>" class="btn btn-primary">Fazer orçamento</a>
                                        </div>
                                    </div>
                                        ...
                                        <form class="dropdown-menu p-4 col-md-12 ">
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <hr class="">
                                                    <span class="fw-medium">Descrição orçamento: </span> <br><br> <span class="fw-normal"> <?php echo "$descricao" ?> </span>
